...
```
    ...
    C:\Users\cy511\Dropbox\Jupyter\Cousera\Improving Deep Neural Networks\W1A2\reg_utils.py:236: RuntimeWarning: divide by zero encountered in log
      logprobs = np.multiply(-np.log(a3),Y) + np.multiply(-np.log(1 - a3), 1 - Y)
    C:\Users\cy511\Dropbox\Jupyter\Cousera\Improving Deep Neural Networks\W1A2\reg_utils.py:236: RuntimeWarning: invalid value encountered in multiply
      logprobs = np.multiply(-np.log(a3),Y) + np.multiply(-np.log(1 - a3), 1 - Y)
